...
class Cliente:
    ...
    def __init__(self, nome_cliente, cpf_cliente, conta_cliente,numero_conta, agencia, extrato):
    ...
    def __str__(self):
        return f"Nome: {self.nome_cliente} | CPF: {self.cpf_cliente}| Conta: {self.conta_cliente} | Numero_conta: {self.numero_conta} | Agência: {self.agencia} | Extrato: {self.extrato}" 
